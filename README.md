# ModShot-Core
[![Build Modshot](https://github.com/Astrabit-ST/ModShot-Core/actions/workflows/build-standalone.yaml/badge.svg)](https://github.com/Astrabit-ST/ModShot-Core/actions/workflows/build-standalone.yaml)[![Build Modshot with Steam support](https://github.com/Astrabit-ST/ModShot-Core/actions/workflows/build-steam.yaml/badge.svg)](https://github.com/Astrabit-ST/ModShot-Core/actions/workflows/build-steam.yaml)[![Build Modshot with MSYS2](https://github.com/Astrabit-ST/ModShot-Core/actions/workflows/build-mys2.yml/badge.svg)](https://github.com/Astrabit-ST/ModShot-Core/actions/workflows/build-mys2.yml)
---
